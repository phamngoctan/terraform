...
output "private_subnets" {
  value = join(", ", [aws_subnet.private-subnet-1.id, aws_subnet.private-subnet-2.id, aws_subnet.private-subnet-3.id])
}

output "public_subnets" {
  value = join(", ", [aws_subnet.public-subnet-1.id, aws_subnet.public-subnet-2.id, aws_subnet.public-subnet-3.id])
}
